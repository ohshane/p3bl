...
| 3.2     | Collaboration         | Multi-persona Group Chat                | Group chat with multiple personas                                                     |
| 3.2.1   | Dynamic Workspace     | Dynamic Workspace                       | Context-aware collaborative workspace                                                 |
| 3.2.1.1 | Dynamic Workspace     | Active Conversation (Multiple Personas) | Active multi-persona conversation                                                     |
